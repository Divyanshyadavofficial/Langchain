...
from langchain_community.embeddings import HuggingFaceEmbeddings  # for HF models

# Load HuggingFace embeddings model (you can pick a small one for testing)
# Some popular options: "sentence-transformers/all-MiniLM-L6-v2", "BAAI/bge-base-en", etc.
embeddings = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2")

# Initialize SemanticChunker with HF embeddings
